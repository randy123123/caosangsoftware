<%@ Control Language="C#" Inherits="CoolStuffs.Sharepoint.CustomFields.CascadingDropDowns.FieldControllers.ChildDropDownListFieldEditControl,CoolStuffs.Sharepoint.CustomFields, Version=1.0.0.0, Culture=neutral, PublicKeyToken=968ece0422c73ea5"   AutoEventWireup="false" %>
...
<wssuc:InputFormSection runat="server" id="MySections" Title="Child Drop Down List Details">
    <Template_Description>
            ...
            <b>Step4 : </b>Select the column to Join on to Parent to get the Filtered Values<br />
        </Template_Description>
