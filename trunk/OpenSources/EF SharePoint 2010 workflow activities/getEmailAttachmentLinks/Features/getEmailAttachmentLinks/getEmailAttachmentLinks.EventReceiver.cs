...
namespace EFSPWFActivities.Features.getEmailAttachmentLinks
{
    /// <summary>
    ...
    [Guid("d9dbdbb2-2078-428a-aa7a-69423b90d975")]
    public class getEmailAttachmentLinksEventReceiver : SPFeatureReceiver
    {
        ...
        {
            string assemblyValue = typeof(EFSPWFActivities.getEmailAttachmentLinks).Assembly.FullName;
            string namespaceValue = typeof(EFSPWFActivities.getEmailAttachmentLinks).Namespace;
