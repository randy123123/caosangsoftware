...
namespace EFSPWFActivities.Features.getListIDByListTitle
{
    /// <summary>
    ...
    [Guid("973ce711-d4f3-4bc3-9ff8-0b9c5f873b1a")]
    public class getListIDByListTitleEventReceiver : SPFeatureReceiver
    {
        ...
        {
            string assemblyValue = typeof(EFSPWFActivities.getListIDByListTitle).Assembly.FullName;
            string namespaceValue = typeof(EFSPWFActivities.getListIDByListTitle).Namespace;
