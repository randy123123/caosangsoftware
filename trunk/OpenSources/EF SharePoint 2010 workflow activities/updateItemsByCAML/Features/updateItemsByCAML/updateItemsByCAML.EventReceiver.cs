...
namespace EFSPWFActivities.Features.updateItemsByCAML
{
    /// <summary>
    ...
    [Guid("81cacdc9-63ab-4fe4-bd35-6c4bc91b07e7")]
    public class updateItemsByCAMLEventReceiver : SPFeatureReceiver
    {
        ...
        {
            string assemblyValue = typeof(EFSPWFActivities.updateItemsByCAML).Assembly.FullName;
            string namespaceValue = typeof(EFSPWFActivities.updateItemsByCAML).Namespace;
