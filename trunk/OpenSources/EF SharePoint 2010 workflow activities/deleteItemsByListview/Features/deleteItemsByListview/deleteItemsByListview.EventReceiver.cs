...
namespace EFSPWFActivities.Features.deleteItemsByListview
{
    /// <summary>
    ...
    [Guid("7ee9bbb1-aafd-4460-ad60-c97e71f9c5d2")]
    public class deleteItemsByListviewEventReceiver : SPFeatureReceiver
    {
        ...
        {
            string assemblyValue = typeof(EFSPWFActivities.deleteItemsByListview).Assembly.FullName;
            string namespaceValue = typeof(EFSPWFActivities.deleteItemsByListview).Namespace;
