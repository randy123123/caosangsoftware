...
namespace EFSPWFActivities.Features.waitForSeconds
{
    /// <summary>
    ...
    [Guid("2d1c16ba-caf7-4810-82de-830d3b8b8d7d")]
    public class waitForSecondsEventReceiver : SPFeatureReceiver
    {
        ...
        {
            string assemblyValue = typeof(EFSPWFActivities.waitForSeconds).Assembly.FullName;
            string namespaceValue = typeof(EFSPWFActivities.waitForSeconds).Namespace;
