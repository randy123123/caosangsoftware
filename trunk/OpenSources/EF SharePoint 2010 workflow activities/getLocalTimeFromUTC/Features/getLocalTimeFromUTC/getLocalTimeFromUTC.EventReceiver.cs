...
namespace EFSPWFActivities.Features.getLocalTimeFromUTC
{
    /// <summary>
    ...
    [Guid("7a57694d-8deb-4a92-9a7f-eb897b5d1f12")]
    public class getLocalTimeFromUTCEventReceiver : SPFeatureReceiver
    {
        ...
        {
            string assemblyValue = typeof(EFSPWFActivities.getLocalTimeFromUTC).Assembly.FullName;
            string namespaceValue = typeof(EFSPWFActivities.getLocalTimeFromUTC).Namespace;
