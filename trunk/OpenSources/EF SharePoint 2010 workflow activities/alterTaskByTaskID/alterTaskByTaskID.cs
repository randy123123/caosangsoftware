...
namespace EFSPWFActivities
{
    public class alterTaskByTaskID : Activity
    {
        ...
        public static void WriteInfoToHistoryLog(SPWeb web, Guid workflow, string description)
        {
            ...
            {
                SPWorkflow.CreateHistoryEvent(web, workflow, 0, web.CurrentUser, ts, "alterTaskByTaskID", description, string.Empty);
            });
        }
