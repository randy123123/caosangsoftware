...
namespace EFSPWFActivities.Features.updateItemsByListview
{
    /// <summary>
    ...
    [Guid("d99f4705-e64e-45b5-8dcd-d42a8c025839")]
    public class updateItemsByListviewEventReceiver : SPFeatureReceiver
    {
        ...
        {
            string assemblyValue = typeof(EFSPWFActivities.updateItemsByListview).Assembly.FullName;
            string namespaceValue = typeof(EFSPWFActivities.updateItemsByListview).Namespace;
