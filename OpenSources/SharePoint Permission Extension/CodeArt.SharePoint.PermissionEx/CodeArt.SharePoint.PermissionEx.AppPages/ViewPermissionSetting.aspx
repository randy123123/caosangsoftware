...
CodeBehind="ViewPermissionSetting.aspx.cs"
 Inherits="CodeArt.SharePoint.PermissionEx.AppPages.ViewPermissionSetting" %>
...
//----------------------------------------------------------------
  ...
  <%-- protected void Page_Load(object send, EventArgs e)
    {
        section1.Description = CodeArt.SharePoint.PermissionEx.Resources.CodeartPermissionEx.ViewPer_Description;
    }--%>
      
</script>

<asp:Content ID="Content1" ContentPlaceHolderId="PlaceHolderPageTitleInTitleArea" runat="server">
<%=GetResource("ViewPermissionEx")%>
 </asp:Content>
 
   <asp:Content ID="Content2" contentplaceholderid="PlaceHolderPageDescription" runat="server">
<%=GetResource("ViewPer_SubTitle")%>
 </asp:Content>
...
.ms-authoringcontrols{ width:580px; }
	...
	<table class=propertysheet border="0" width="100%" cellspacing="0" cellpadding="0" id="diidProjectPageOverview">
			...
			<wssuc:InputFormSection id="section1" Title=""         
				Description=""
				runat="server">
...
<codeArt:ViewRightsSettingPart runat="server" id="fSetting" />
