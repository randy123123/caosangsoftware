...
namespace EFSPWFActivities.Features
{
    /// <summary>
    ...
    [Guid("bda5b281-f6cc-4810-ac61-693a8c222cbd")]
    public class getUserLoginsByGroupNameEventReceiver : SPFeatureReceiver
    {
        ...
        {
            string assemblyValue = typeof(EFSPWFActivities.getUserLoginsByGroupName).Assembly.FullName;
            string namespaceValue = typeof(EFSPWFActivities.getUserLoginsByGroupName).Namespace;
