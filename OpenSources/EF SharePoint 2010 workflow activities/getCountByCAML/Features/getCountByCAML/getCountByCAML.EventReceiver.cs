...
namespace EFSPWFActivities.Features.getCountByCAML
{
    /// <summary>
    ...
    public class getCountByCAMLEventReceiver : SPFeatureReceiver
    {
        ...
        {
            string assemblyValue = typeof(EFSPWFActivities.getCountByCAML).Assembly.FullName;
            string namespaceValue = typeof(EFSPWFActivities.getCountByCAML).Namespace;
