...
namespace EFSPWFActivities.Features.CalculateBusinessHours
{
    /// <summary>
    ...
    [Guid("497b237d-3020-4352-a87f-51eb15c9398e")]
    public class CalculateBusinessHoursEventReceiver : SPFeatureReceiver
    {
        ...
        {
            string assemblyValue = typeof(EFSPWFActivities.CalculateBusinessHours).Assembly.FullName;
            string namespaceValue = typeof(EFSPWFActivities.CalculateBusinessHours).Namespace;
