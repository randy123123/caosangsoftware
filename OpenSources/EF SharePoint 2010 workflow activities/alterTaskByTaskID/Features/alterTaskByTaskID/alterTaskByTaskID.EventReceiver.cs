...
namespace EFSPWFActivities.Features.alterTaskByTaskID
{
    /// <summary>
    ...
    public class alterTaskByTaskIDEventReceiver : SPFeatureReceiver
    {
        ...
        {
            string assemblyValue = typeof(EFSPWFActivities.alterTaskByTaskID).Assembly.FullName;
            string namespaceValue = typeof(EFSPWFActivities.alterTaskByTaskID).Namespace;
