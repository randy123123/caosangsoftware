...
namespace EFSPWFActivities.Features.deleteItemsByCAML
{
    /// <summary>
    ...
    [Guid("0cde7e81-cd0f-4fba-b0ff-95b5bd92ef84")]
    public class deleteItemsByCAMLEventReceiver : SPFeatureReceiver
    {
        ...
        {
            string assemblyValue = typeof(EFSPWFActivities.deleteItemsByCAML).Assembly.FullName;
            string namespaceValue = typeof(EFSPWFActivities.deleteItemsByCAML).Namespace;
