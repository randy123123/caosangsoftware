...
namespace EFSPWFActivities.Features.getFieldValueByCAML
{
    /// <summary>
    ...
    [Guid("8fea2997-37be-4627-a085-205ae8c2b3cb")]
    public class getFieldValueByCAMLEventReceiver : SPFeatureReceiver
    {
        ...
        {
            string assemblyValue = typeof(EFSPWFActivities.getFieldValueByCAML).Assembly.FullName;
            string namespaceValue = typeof(EFSPWFActivities.getFieldValueByCAML).Namespace;
