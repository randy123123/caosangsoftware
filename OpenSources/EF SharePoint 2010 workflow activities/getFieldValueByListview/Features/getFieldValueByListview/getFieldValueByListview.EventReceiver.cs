...
namespace EFSPWFActivities.Features.getFieldValueByListview
{
    /// <summary>
    ...
    [Guid("1bf19b9e-e515-4083-9a81-86b3b3791649")]
    public class getFieldValueByListviewEventReceiver : SPFeatureReceiver
    {
        ...
        {
            string assemblyValue = typeof(EFSPWFActivities.getFieldValueByListview).Assembly.FullName;
            string namespaceValue = typeof(EFSPWFActivities.getFieldValueByListview).Namespace;
