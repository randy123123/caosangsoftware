...
namespace EFSPWFActivities.Features.getCurrentDateTime
{
    /// <summary>
    ...
    [Guid("41536823-8595-4e2d-9031-4a594f1e45fd")]
    public class getCurrentDateTimeEventReceiver : SPFeatureReceiver
    {
        ...
        {
            string assemblyValue = typeof(EFSPWFActivities.getCurrentDateTime).Assembly.FullName;
            string namespaceValue = typeof(EFSPWFActivities.getCurrentDateTime).Namespace;
