...
namespace EFSPWFActivities.Features.completeTaskByTaskID
{
    /// <summary>
    ...
    [Guid("5549a09f-d39a-4b1f-9dc8-714ff62257a5")]
    public class completeTaskByTaskIDEventReceiver : SPFeatureReceiver
    {
        ...
        {
            string assemblyValue = typeof(EFSPWFActivities.completeTaskByTaskID).Assembly.FullName;
            string namespaceValue = typeof(EFSPWFActivities.completeTaskByTaskID).Namespace;
